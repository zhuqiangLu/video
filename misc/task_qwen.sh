...
TASK=lmms-lab/Video-MME # TIGER-Lab/VideoEval-Pro
...
case $TASK in
    "lmms-lab/Video-MME")
        VIDEO_ROOT=~/.cache/huggingface/hub/datasets--lmms-lab--Video-MME/snapshots/ead1408f75b618502df9a1d8e0950166bf0a2a0b/data
        DATA_FILES=~/.cache/huggingface/hub/datasets--lmms-lab--Video-MME/snapshots/ead1408f75b618502df9a1d8e0950166bf0a2a0b/videomme/test-00000-of-00001.parquet
        ;;
    "TIGER-Lab/VideoEval-Pro")
        VIDEO_ROOT=~/.cache/huggingface/hub/datasets--TIGER-Lab--VideoEval-Pro/snapshots/a38a853b22576c7918e9cc0d1d4eedf9d46a1cae/videos/videos_filtered/
        DATA_FILES=~/.cache/huggingface/hub/datasets--TIGER-Lab--VideoEval-Pro/snapshots/a38a853b22576c7918e9cc0d1d4eedf9d46a1cae/data/test-00000-of-00001.parquet
        ;;
    "motionbench")
...
#         --num_gpus $NUM_GPUS \
#         --custom_question 'static_video_bool' \
#         --max_num_frames 16 \
#         --limit 1.0 \
#         --cur_gpu $i &
# done
...
# done
# wait
echo "Running task $TASK, with $NUM_GPUS GPUs"

for i in $(seq 0 $((NUM_GPUS-1)))
do
    echo "Running task $TASK, with $i th GPUs"
    python qwen25vl.py \
        --dataset_name $TASK \
        --video_root  $VIDEO_ROOT \
