class ModelingFuncsBuilder:
    ...
    def register(self, model_base, setup_model_func, get_inputs_func, inference_func=None):
        self.model_base_funcs[model_base] = (setup_model_func, get_inputs_func, inference_func)
