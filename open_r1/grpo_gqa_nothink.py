...
from src.open_r1.trainer import Qwen2VLGRPOTrainer_Video_GQA_nothink as Qwen2VLGRPOTrainer
...
reward_funcs_registry = {
    "iou": iou_glue_reward, # Modified registry to use iou_timestamp_reward
