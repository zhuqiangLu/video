...
from src.open_r1.trainer import Qwen2VLGRPOTrainer_Video_TG as Qwen2VLGRPOTrainer
from src.open_r1.trainer import Qwen2VLGRPOVLLMTrainer_Video_TG as Qwen2VLGRPOVLLMTrainer
    ...
    def create_dataset_from_json(file_path, split_name):
        ...
        for video_id, video_data in tqdm(data.items()):
            for sentence_id, (timestamps, sentence) in enumerate(zip(video_data['timestamps'], video_data['sentences'])):
                ...
                # example["preprocessed_path"] = video_path
