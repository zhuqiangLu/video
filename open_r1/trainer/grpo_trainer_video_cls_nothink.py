...
Output your final answer within the <answer> </answer> tags.
"""

class Qwen2VLGRPOTrainer_Video_CLS_nothink(Trainer):
    """
    ...
    def make_conversation_video(self, example):
        example_prompt = QUESTION_TEMPLATE.replace("[PROBLEM]", example["problem"])
